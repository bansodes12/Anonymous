...
public class Utility {
	...
	public static String readDataFromPropertyFile(String key) throws IOException
	{
		...
		FileInputStream myfile= new FileInputStream("C:\\Users\\banso\\eclipse-workspace\\20_Aug_eve_MVN\\NeoStoxproperties.properties");
		//3.load file
		prop.load(myfile);
	...
	public static void takeScreenshot(WebDriver driver,String fileName) throws IOException
	{
		...
		File dest=new File("C:\\Users\\banso\\Desktop\\software testing\\screenshot\\"+fileName+".png");
